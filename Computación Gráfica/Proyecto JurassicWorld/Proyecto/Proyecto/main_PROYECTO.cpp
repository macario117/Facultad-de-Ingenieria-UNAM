...
{
	glPushMatrix();
	glTranslatef(-17, 7.5, 50);
	glRotatef(180, 0, 0, 1);
	glScalef(30, 15, 0.1);
	glDisable(GL_LIGHTING);
	fig18.prisma3(0, text28.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();
...
void dinosaurios() 
{
	...
	glTranslatef(-12, 3.8, 43.4);
	//glRotatef(-40, 1, 0, 0);
	glScalef(1.4, 1, 2.5);
	glDisable(GL_LIGHTING);
	fig45.prisma3(text29.GLindex, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();
	...
	//ojos 
	glPushMatrix();
	glTranslatef(-11.25, 4, 43.4);
	glRotatef(90, 0, 1, 0);
	//glScalef(1.4, 1, 2.5);
	glDisable(GL_LIGHTING);
	fig46.esfera(0.2, 100, 100, text10.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(-12.7, 4, 43.4);
	glRotatef(180, 0, 1, 0);
	//glScalef(1.4, 1, 2.5);
	glDisable(GL_LIGHTING);
	fig46.esfera(0.2, 100, 100, text10.GLindex);
	...
	glTranslatef(-12, 2.9, 44.7);
	glRotatef(-40, 1, 0, 0);
	glScalef(1.7, 2.2, 1.5);
	glDisable(GL_LIGHTING);
	fig47.prisma3(text29.GLindex, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();
	...
	glTranslatef(-12.9, 2.7, 43.5);
	glRotatef(-20, 1, 0, 0);
	glScalef(0.2, 0.5, 1.8);
	glDisable(GL_LIGHTING);
	fig47.prisma3(text29.GLindex, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();
...
//Panza
	...
	//der
	glPushMatrix();
	glTranslatef(-12.5, 0.9, 44.9);
	glRotatef(12, 1, 0, 0);
	glScalef(0.6, 0.9, 0.3);
	glDisable(GL_LIGHTING);
	fig47.prisma3(0, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(-12.5, 0.2, 44.92);
	glRotatef(-12, 1, 0, 0);
	glScalef(0.6, 0.9, 0.3);
	glDisable(GL_LIGHTING);
	fig47.prisma3(0, text29.GLindex);
	...
	//pat
	glPushMatrix();
	glTranslatef(-12.5, 0, 44.92);
	glRotatef(180, 0, 0, 1);
	glScalef(0.8, 0.3, 1);
	glDisable(GL_LIGHTING);
	fig48.prisma3(0, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();
	//garras 1

	glPushMatrix();
	glTranslatef(-12.2, 0, 44.8);
	glRotatef(-90, 1, 0, 0);
	glScalef(1, 1, 1);
	glDisable(GL_LIGHTING);
	fig48.cono(0.7, 0.2, 100, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(-12.5, 0, 44.8);
	glRotatef(-90, 1, 0, 0);
	glScalef(1, 1, 1);
	glDisable(GL_LIGHTING);
	fig48.cono(0.7, 0.2, 100, text29.GLindex);
	...
	glPushMatrix();
	glTranslatef(-11.4, 0.15, 44.92);
	glRotatef(-12, 1, 0, 0);
	glScalef(0.6, 0.9, 0.3);
	glDisable(GL_LIGHTING);
	fig49.prisma3(0, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();

	//pat
	glPushMatrix();
	glTranslatef(-11.4, 0, 44.92);
	glRotatef(180, 0, 0, 1);
	glScalef(0.8, 0.3, 1);
	glDisable(GL_LIGHTING);
	fig49.prisma3(0, text29.GLindex);
	...
	glPushMatrix();
	glTranslatef(-11.2, 0, 44.8);
	glRotatef(-90, 1, 0, 0);
	glScalef(1, 1, 1);
	glDisable(GL_LIGHTING);
	fig50.cono(0.7, 0.2, 100, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(-11.5, 0, 44.8);
	glRotatef(-90, 1, 0, 0);
	glScalef(1, 1, 1);
	glDisable(GL_LIGHTING);
	fig50.cono(0.7, 0.2, 100, text29.GLindex);
	...
	//CONSTRUCCION DEL CUERPO
			...
			glPushMatrix();
				...
				glTranslatef(-17, 3.8, 43.4);
				//glRotatef(-40, 1, 0, 0);
				glScalef(1.4, 1, 2.5);
				glDisable(GL_LIGHTING);
				fig29.prisma3(text29.GLindex, text29.GLindex);
				glEnable(GL_LIGHTING);
			glPopMatrix();
			...
			//ojos 
			glPushMatrix();
			glTranslatef(-16.25, 4, 43.4);
			glRotatef(90, 0, 1, 0);
			//glScalef(1.4, 1, 2.5);
			glDisable(GL_LIGHTING);
			fig33.esfera(0.2, 100, 100, text10.GLindex);
			glEnable(GL_LIGHTING);
			glPopMatrix();

			glPushMatrix();
			glTranslatef(-17.7, 4, 43.4);
			glRotatef(180, 0, 1, 0);
			//glScalef(1.4, 1, 2.5);
			glDisable(GL_LIGHTING);
			fig33.esfera(0.2, 100, 100, text10.GLindex);
			...
			glTranslatef(-17, 2.7, 46.5);
			glRotatef(-31, 1, 0, 0);
			glScalef(0.4, 0.5, 2);
			glDisable(GL_LIGHTING);
			fig33.prisma3(text29.GLindex, text29.GLindex);
			glEnable(GL_LIGHTING);
			glPopMatrix();
			// der 
		...
		//Panza
			glPushMatrix();
				...
				glTranslatef(-17, 1.9, 45);
				glRotatef(180, 0, 0, 1);
				glScalef(2, 1.4, 1.5);
				glDisable(GL_LIGHTING);
				fig27.prisma3(text29.GLindex, text29.GLindex);
				glEnable(GL_LIGHTING);
			glPopMatrix();
		...
		//der
			glPushMatrix();
			glTranslatef(-17.5, 0.9, 44.9);
			glRotatef(12, 1, 0, 0);
			glScalef(0.6, 0.9, 0.3);
			glDisable(GL_LIGHTING);
			fig27.prisma3(0, text29.GLindex);
			glEnable(GL_LIGHTING);
			glPopMatrix();

			glPushMatrix();
			glTranslatef(-17.5, 0.2, 44.92);
			glRotatef(-12, 1, 0, 0);
			glScalef(0.6, 0.9, 0.3);
			glDisable(GL_LIGHTING);
			fig27.prisma3(0, text29.GLindex);
			...
			glPushMatrix();
			glTranslatef(-17.2, 0, 44.8);
			glRotatef(-90, 1, 0, 0);
			glScalef(1, 1, 1);
			glDisable(GL_LIGHTING);
			fig28.cono(0.7, 0.2, 100, text29.GLindex);
			glEnable(GL_LIGHTING);
			glPopMatrix();

			glPushMatrix();
			glTranslatef(-17.5, 0, 44.8);
			glRotatef(-90, 1, 0, 0);
			glScalef(1, 1, 1);
			glDisable(GL_LIGHTING);
			fig28.cono(0.7, 0.2, 100, text29.GLindex);
	...
	glTranslatef(-22, 2.9, 44.7);
	glRotatef(-40, 1, 0, 0);
	glScalef(1.7, 2.2, 1.5);
	glDisable(GL_LIGHTING);
	fig35.prisma3(text29.GLindex, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();
	...
	glTranslatef(-22.9, 2.7, 43.5);
	glRotatef(-20, 1, 0, 0);
	glScalef(0.2, 0.5, 1.8);
	glDisable(GL_LIGHTING);
	fig36.prisma3(text29.GLindex, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(-21.2, 2.7, 43.5);
	glRotatef(-20, 1, 0, 0);
	glScalef(0.2, 0.5, 1.8);
	glDisable(GL_LIGHTING);
	fig36.prisma3(text29.GLindex, text29.GLindex);
	...
	glTranslatef(-22, 2.7, 46.5);
	glRotatef(-31, 1, 0, 0);
	glScalef(0.4, 0.5, 2);
	glDisable(GL_LIGHTING);
	fig37.prisma3(text29.GLindex, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();
	// der 
...
//Panza
	...
	//der
	glPushMatrix();
	glTranslatef(-22.5, 0.9, 44.9);
	glRotatef(12, 1, 0, 0);
	glScalef(0.6, 0.9, 0.3);
	glDisable(GL_LIGHTING);
	fig37.prisma3(0, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(-22.5, 0.2, 44.92);
	glRotatef(-12, 1, 0, 0);
	glScalef(0.6, 0.9, 0.3);
	glDisable(GL_LIGHTING);
	fig37.prisma3(0, text29.GLindex);
	...
	//pat
	glPushMatrix();
	glTranslatef(-22.5, 0, 44.92);
	glRotatef(180, 0, 0, 1);
	glScalef(0.8, 0.3, 1);
	glDisable(GL_LIGHTING);
	fig38.prisma3(0, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();
	//garras 1

	glPushMatrix();
	glTranslatef(-22.2, 0, 44.8);
	glRotatef(-90, 1, 0, 0);
	glScalef(1, 1, 1);
	glDisable(GL_LIGHTING);
	fig39.cono(0.7, 0.2, 100, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(-22.5, 0, 44.8);
	glRotatef(-90, 1, 0, 0);
	glScalef(1, 1, 1);
	glDisable(GL_LIGHTING);
	fig39.cono(0.7, 0.2, 100, text29.GLindex);
	...
	//izq
	glPushMatrix();
	glTranslatef(-21.4, 0.85, 44.9);
	glRotatef(12, 1, 0, 0);
	glScalef(0.6, 0.9, 0.3);
	glDisable(GL_LIGHTING);
	fig40.prisma3(0, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(-21.4, 0.15, 44.92);
	glRotatef(-12, 1, 0, 0);
	glScalef(0.6, 0.9, 0.3);
	glDisable(GL_LIGHTING);
	fig40.prisma3(0, text29.GLindex);
	...
	glPushMatrix();
	glTranslatef(-21.2, 0, 44.8);
	glRotatef(-90, 1, 0, 0);
	glScalef(1, 1, 1);
	glDisable(GL_LIGHTING);
	fig41.cono(0.7, 0.2, 100, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(-21.5, 0, 44.8);
	glRotatef(-90, 1, 0, 0);
	glScalef(1, 1, 1);
	glDisable(GL_LIGHTING);
	fig42.cono(0.7, 0.2, 100, text29.GLindex);
	glEnable(GL_LIGHTING);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(-21.8, 0, 44.8);
	glRotatef(-90, 1, 0, 0);
	glScalef(1, 1, 1);
	glDisable(GL_LIGHTING);
	fig42.cono(0.7, 0.2, 100, text29.GLindex);
...
void InitGL(GLvoid)     // Inicializamos parametros
{
	...
	text28.LoadTGA("letrero.tga");
	text28.BuildGLTexture();
	text28.ReleaseImage();

	text29.LoadTGA("dino.tga");
...
glPopMatrix();
	...
	pintaTexto(-11, 12.0, -14.0, (void *)font, "JURASSIC WORLD");
